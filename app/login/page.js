    ...
    <main style={{ paddingTop: '120px', maxWidth: '500px', margin: '0 auto', minHeight: '100vh', padding: '120px 20px 60px' }}>
      ...
      <form onSubmit={handleSubmit} style={{ background: 'rgba(18,20,28,0.7)', backdropFilter: 'blur(8px)', borderRadius: '16px', padding: '40px', border: '1px solid rgba(0,212,255,0.1)' }}>
        ...
        <div style={{ textAlign: 'center' }}>
          <Link href="/register" style={{ color: '#00d4ff', fontFamily: "'Inter', sans-serif", fontSize: '0.9rem', textDecoration: 'none' }}>Регистрация</Link>
          <span style={{ color: '#6a7280', margin: '0 12px' }}>|</span>
          <Link href="/password-reset" style={{ color: '#00d4ff', fontFamily: "'Inter', sans-serif", fontSize: '0.9rem', textDecoration: 'none' }}>Забыли пароль?</Link>
        </div>
      </form>
    </main>
  );
