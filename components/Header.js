...
const links = [
  ...
  { href: '/kstudio', label: 'Студии с кадастром', icon: <GridIcon /> },
  { href: '/dstudio', label: 'Долевые студии', icon: <LayersIcon /> },
  { href: '/law', label: 'Закон', icon: <LayersIcon /> },
  { href: '/about', label: 'О компании', icon: <UserIcon /> },
  { href: '/contacts', label: 'Контакты', icon: <PhoneIcon /> },
  { href: '/calculator', label: 'Калькулятор', icon: <CalculatorIcon /> },
  { href: '/account', label: 'Личный кабинет', icon: <LockIcon /> },
  { href: '/login', label: 'Вход', icon: <LogInIcon /> },
  { href: '/register', label: 'Регистрация', icon: <PlusIcon /> },
  { href: '/faq', label: 'FAQ', icon: <HelpCircleIcon /> },
  { href: '/reviews', label: 'Отзывы', icon: <MessageSquareIcon /> },
  { href: '/blog', label: 'Блог', icon: <BookOpenIcon /> },
  { href: '/careers', label: 'Вакансии', icon: <BriefcaseIcon /> },
  { href: '/partners', label: 'Партнёрам', icon: <UsersIcon /> },
  { href: '/policy', label: 'Политика', icon: <ShieldIcon /> },
  { href: '/agreement', label: 'Соглашение', icon: <FileTextIcon /> },
];
